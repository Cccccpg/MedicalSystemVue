<template>
  <div class="app-container">
      ...
      <!-- 工具条 -->
      <div>
         <el-button type="danger" size="mini" @click="removeRows()" :disabled="multipleSelection.length === 0">批量删除</el-button>
      </div>
      ...
      :data="list" stripe style="width: 100%" @selection-change="handleSelectionChange">
         ...
         <el-table-column prop="apiUrl" label="api基础路径" width="300"/>
         ...
         <el-table-column label="操作" width="280" align="center">
            ...
            <el-button type="danger" size="mini" 
                  icon="el-icon-delete" @click="removeDataById(scope.row.id)" title="删除"></el-button>
